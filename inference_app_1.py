...
def _predict_core(state: str, district: str, crop: str,
    ...
    return {
        ...
        "yield_per_hectare": float(yield_pred),
        "yield_lower": float(pred_lower),
        "yield_upper": float(pred_upper),
        "production_pred": float(production_pred),
        "production_lower": float(pred_lower * land_area),
        "production_upper": float(pred_upper * land_area),
